...
Enemy::Enemy(float lp, float speed, float resistance, bool fly, float cellSize) :
Entity{{0,0}}, lp_{lp}, speed_{speed}, resistance_{resistance}, fly_{fly}, path_{}, offset_{0.0f}, cellSize_{cellSize} {
...
std::vector<Sprites::Sprite*> Enemy::createSprites(SDL_Color color) {
    // base : 
    Sprites::PrimitiveForm * Core = Sprites::triangle({0.0f,0.0f,1.0f}, 5);
